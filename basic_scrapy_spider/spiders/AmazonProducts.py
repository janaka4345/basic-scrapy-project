...
class AmazonSearchProductSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for keyword in keyword_list:
            # 'https://proxy.scrapeops.io/v1/?api_key=748837e3-9080-420f-b8cb-40fd7633145d&url=https://amazon.com'
            amazon_search_url = f"https://proxy.scrapeops.io/v1/?api_key=748837e3-9080-420f-b8cb-40fd7633145d&url=https://www.amazon.com/s?k={keyword}&page=1"
    ...
    def discover_product_urls(self, response):
        ...
        for product in search_products:
            yield {
                ...
                # "product_name":product.css("h2>a::attr(href)").get()
            }

    #         product_url = urljoin(
    #             "https://proxy.scrapeops.io/v1/?api_key=748837e3-9080-420f-b8cb-40fd7633145d&url=https://www.amazon.com/",
    #             relative_url,
    #         ).split("?")[0]
    #         yield scrapy.Request(
    #             url=product_url,
    ...
    #         amazon_search_url = f"https://proxy.scrapeops.io/v1/?api_key=748837e3-9080-420f-b8cb-40fd7633145d&url=https://www.amazon.com/s?k={keyword}&page={page_num}"
    #         yield scrapy.Request(
    #             url=amazon_search_url,
    #             callback=self.discover_product_urls,
